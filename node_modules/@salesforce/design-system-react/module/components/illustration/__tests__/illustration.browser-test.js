...
var DemoIllustration = /*#__PURE__*/function (_React$Component) {
  _inherits(DemoIllustration, _React$Component);

  var _super = _createSuper(DemoIllustration);
  ...
  _createClass(DemoIllustration, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(Illustration, _extends({}, this.props, {
...
describe('SLDSIllustration: ', function describeFunction() {
  describe('Image with heading and message render', function describeFunction2() {
    ...
    var heading;
    var messageBody;
    beforeEach(mountComponent( /*#__PURE__*/React.createElement(DemoIllustration, {
