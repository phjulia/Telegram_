...
var DemoComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DemoComponent, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(Popover, this.props, /*#__PURE__*/React.createElement(Button, {
...
describe('SLDSFilter', function describeFunction() {
  ...
  describe('Add custom props to Filter Popover', function () {
    ...
    it('Filter could take popover as a prop and use the props of popover to render, verifies the custom popover className', function () {
      var demoPopover = /*#__PURE__*/React.createElement(DemoComponent, {
        className: "custom-filter-popover",
        isOpen: true,
        position: "absolute"
      });
      wrapper = mount( /*#__PURE__*/React.createElement(IconSettings, {
