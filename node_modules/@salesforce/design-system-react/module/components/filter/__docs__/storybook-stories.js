...
storiesOf(FILTER, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(Default, null));
}).add('New Filter', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(NewFilter, null));
}).add('Locked Filter', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(LockedFilter, null));
}).add('Permanant Filter', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(PermanantFilter, null));
}).add('Filter Align Right', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, {
    align: "right"
  }, /*#__PURE__*/React.createElement(Default, {
    align: "right"
  }));
}).add('AssistiveTextFilter', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(AssistiveTextFilter, null));
}).add('ErrorFilter', function () {
  return /*#__PURE__*/React.createElement(CustomAlignment, null, /*#__PURE__*/React.createElement(ErrorFilter, null));
});
