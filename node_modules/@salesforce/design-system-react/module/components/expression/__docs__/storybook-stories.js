...
storiesOf(EXPRESSION, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(Initial, {
    action: action
  });
}).add('w/ Resource Selected', function () {
  return /*#__PURE__*/React.createElement(ResourceSelected, {
    action: action
  });
}).add('w/ Multiple Conditions', function () {
  return /*#__PURE__*/React.createElement(MultipleConditions, {
    action: action
  });
}).add('w/ Group', function () {
  return /*#__PURE__*/React.createElement(WithGroup, {
    action: action
  });
}).add('w/ Custom Logic', function () {
  return /*#__PURE__*/React.createElement(CustomLogic, {
    action: action
  });
}).add('w/ Formula Logic', function () {
  return /*#__PURE__*/React.createElement(FormulaLogic, {
    action: action
  });
});
