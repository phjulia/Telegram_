...
var getPicklist = function getPicklist(props) {
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Picklist, props), /*#__PURE__*/React.createElement("button", {
    style: {
      padding: '10px',
      margin: '50px'
    }
...
var MultipleExample = /*#__PURE__*/function (_React$Component) {
  _inherits(MultipleExample, _React$Component);

  var _super = _createSuper(MultipleExample);
  ...
  _createClass(MultipleExample, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Picklist, {
        label: "Contacts",
        labels: {
...
storiesOf(MENU_PICKLIST, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(MultipleExample, null);
}).add('Docs site Base', function () {
  return /*#__PURE__*/React.createElement(Base, null);
}).add('Docs site SnapshotDefault', function () {
  return /*#__PURE__*/React.createElement(SnapshotDefault, null);
}).add('Docs site TooltipListItem', function () {
  return /*#__PURE__*/React.createElement(TooltipListItem, null);
});
