...
var AccordionExample = /*#__PURE__*/function (_React$Component) {
  _inherits(AccordionExample, _React$Component);

  var _super = _createSuper(AccordionExample);
  ...
  _createClass(AccordionExample, [{
    ...
    value: function togglePanel(id) {
      this.setState(function (state) {
        return _objectSpread(_objectSpread({}, state), {}, {
          expandedPanels: _objectSpread(_objectSpread({}, state.expandedPanels), {}, _defineProperty({}, id, !state.expandedPanels[id]))
        });
      });
    }
  }, {
...
var AccordionWithOnePanelExample = /*#__PURE__*/function (_React$Component2) {
  _inherits(AccordionWithOnePanelExample, _React$Component2);

  var _super2 = _createSuper(AccordionWithOnePanelExample);
...
describe('Accordion', function describeFunction() {
  ...
  describe('Renders Accordion', function () {
    ...
    it('renders an accordion', function () {
      wrapper = mount( /*#__PURE__*/React.createElement(AccordionExample, null), {
        attachTo: mountNode
      });
    ...
    it('renders accordion with only one panel', function () {
      wrapper = mount( /*#__PURE__*/React.createElement(AccordionWithOnePanelExample, null), {
        attachTo: mountNode
      });
      var accordion = wrapper.find(Accordion);
      expect(accordion).to.be.present;
