...
var VisualPickerExample = /*#__PURE__*/function (_React$Component) {
  _inherits(VisualPickerExample, _React$Component);

  var _super = _createSuper(VisualPickerExample);
  ...
  _createClass(VisualPickerExample, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(VisualPicker, {
        label: this.props.label,
        id: this.props.id,
        size: "medium",
        coverable: true
      }, this.props.type === 'radio' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Radio, {
        labels: {
          label: 'Connected App'
        },
...
describe('SLDS Visual Picker', function () {
  ...
  it('radio switching works correctly', function () {
    wrapper = mount( /*#__PURE__*/React.createElement(VisualPickerExample, {
