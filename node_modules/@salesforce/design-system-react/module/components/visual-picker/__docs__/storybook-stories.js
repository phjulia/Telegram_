...
storiesOf(VISUAL_PICKER, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(Coverable, null);
}).add('Non-Coverable', function () {
  return /*#__PURE__*/React.createElement(NonCoverable, null);
}).add('Links', function () {
  return /*#__PURE__*/React.createElement(Links, null);
}).add('Vertical', function () {
  return /*#__PURE__*/React.createElement(Vertical, null);
}).add('Vertical Coverable', function () {
  return /*#__PURE__*/React.createElement(VerticalCoverable, null);
});
