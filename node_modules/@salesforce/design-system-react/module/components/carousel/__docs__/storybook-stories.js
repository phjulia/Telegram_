...
storiesOf(CAROUSEL, module).add('Default (1 item) NoImageTest', function () {
  ...
  return /*#__PURE__*/React.createElement(DefaultWithNavigation, {
    action: action
  });
}).add('Default with Autoplay NoImageTest', function () {
  return /*#__PURE__*/React.createElement(DefaultWithAutoplay, {
    action: action
  });
}).add('3 items NoImageTest', function () {
  return /*#__PURE__*/React.createElement(ThreeItems, {
    action: action
  });
}).add('3 items controlled isInfinite NoImageTest', function () {
  return /*#__PURE__*/React.createElement(ThreeItemsControlled, {
    action: action
  });
}).add('5 items NoImageTest', function () {
  return /*#__PURE__*/React.createElement(FiveItems, {
    action: action
  });
}).add('With custom items NoImageTest', function () {
  return /*#__PURE__*/React.createElement(WithCustomItems, {
    action: action
  });
});
