...
var DemoComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DemoComponent, [{
    ...
    function render() {
      ...
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Popover, this.props, /*#__PURE__*/React.createElement(Button, {
...
describe('SLDSPopover', function () {
  ...
  describe('Optional props', function () {
    ...
    it('has correct className, assistiveText, style, and footer', function () {
      wrapper = mount( /*#__PURE__*/React.createElement(DemoComponent, _extends({}, optionalProps, {
        isOpen: true
      })), {
        attachTo: mountNode
      });
