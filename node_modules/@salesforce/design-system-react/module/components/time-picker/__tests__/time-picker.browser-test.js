...
describe('SLDSTimepicker: ', function () {
  describe('Timepicker Value Prop Change', function () {
    it('displays a modified state upon changing props', function () {
      ...
      var TestTimepicker = /*#__PURE__*/function (_React$Component) {
        _inherits(TestTimepicker, _React$Component);

        var _super = _createSuper(TestTimepicker);

        function TestTimepicker() {
          var _this;

          _classCallCheck(this, TestTimepicker);
        ...
        _createClass(TestTimepicker, [{
          key: "render",
          value: function render() {
            return /*#__PURE__*/React.createElement(IconSettings, {
              iconPath: "/assets/icons"
            }, /*#__PURE__*/React.createElement(SLDSTimepicker, _extends({
              ref: "timePicker"
            }, defaultProps)));
          }
        }]);
      ...
      var parent = TestUtils.renderIntoDocument( /*#__PURE__*/React.createElement(TestTimepicker, null));
