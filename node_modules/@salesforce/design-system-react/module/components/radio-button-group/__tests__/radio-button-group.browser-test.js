...
var RadioButtonGroupExample = /*#__PURE__*/function (_React$Component) {
  _inherits(RadioButtonGroupExample, _React$Component);

  var _super = _createSuper(RadioButtonGroupExample);
...
describe('RadioButtonGroup', function () {
  ...
  it('renders a radio button group', function () {
    wrapper = mount( /*#__PURE__*/React.createElement(RadioButtonGroupExample, null), {
      attachTo: mountNode
    });
  ...
  it('renders a disabled state', function () {
    wrapper = mount( /*#__PURE__*/React.createElement(RadioButtonGroupExample, {
      disabled: true
    }), {
      attachTo: mountNode
    });
