...
var Example = /*#__PURE__*/function (_React$Component) {
  ...
  function Example() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChangePredicate", function (event, _ref) {
      ...
      }, idSuffix, _objectSpread(_objectSpread({}, _this.state[idSuffix]), {}, {
    ...
    _defineProperty(_assertThisInitialized(_this), "onSelectPicklist", function (selectedItem, id) {
      _this.setState(_defineProperty({}, id, _objectSpread(_objectSpread({}, _this.state[id]), {}, {
    ...
    _defineProperty(_assertThisInitialized(_this), "onRemove", function (event, _ref2) {
      ...
      _this.setState(_defineProperty({}, idSuffix, _objectSpread(_objectSpread({}, _this.state[idSuffix]), {}, {
        isActive: false
      })));
    });
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(IconSettings, {
        ...
        variant: "filters"
      }, /*#__PURE__*/React.createElement(PanelFilterGroup, {
        assistiveText: {
        ...
        variant: "panel"
      }, /*#__PURE__*/React.createElement(PanelFilterList, null, /*#__PURE__*/React.createElement(Filter, {
      ...
      }))), hasActiveFilters ? /*#__PURE__*/React.createElement(PanelFilterListHeading, {
        label: "Matching all these filters"
      }) : null, hasActiveFilters ? /*#__PURE__*/React.createElement(PanelFilterList, null, this.state['created-date'].isActive ? /*#__PURE__*/React.createElement(Filter, {
        id: "sample-panel-filtering-created-date",
        onChange: this.onChangePredicate,
      ...
      })) : null, this.state['list-price'].isActive ? /*#__PURE__*/React.createElement(Filter, {
        id: "sample-panel-filtering-list-price",
        onChange: this.onChangePredicate,
        onRemove: this.onRemove,
      ...
      })) : null, this.state.new.isActive ? /*#__PURE__*/React.createElement(Filter, {
        id: "sample-panel-filtering-new",
