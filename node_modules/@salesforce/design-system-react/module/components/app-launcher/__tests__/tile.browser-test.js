...
describe('SLDS APP LAUNCHER TILE *******************************************', function () {
  ...
  var createTile = function createTile(props) {
    return /*#__PURE__*/React.createElement(AppLauncherTile, assign({}, defaultTileProps, props));
  };
  ...
  function mountTile(props) {
    ...
    handles.tile = mount( /*#__PURE__*/React.createElement(IconSettings, {
  ...
  describe('Default App Launcher Tile', function () {
    ...
    it('search string highlights title', function () {
      ...
      [/*#__PURE__*/React.createElement("span", null, "S"), /*#__PURE__*/React.createElement("mark", null, "upport"), /*#__PURE__*/React.createElement("span", null, " Cloud")])).to.be.true;
    });
    it('search string highlights description', function () {
      ...
      [/*#__PURE__*/React.createElement("span", null, "Fluffy s"), /*#__PURE__*/React.createElement("mark", null, "upport")])).to.be.true;
    });
  });
