...
describe('SLDS APP LAUNCHER *******************************************', function () {
  ...
  var createAppLauncher = function createAppLauncher(props) {
    return /*#__PURE__*/React.createElement(AppLauncher, assign({}, defaultAppLauncherProps, props), /*#__PURE__*/React.createElement(AppLauncherExpandableSection, {
      title: "All Items"
  ...
  function mountAppLauncher(props) {
    handles.appLauncher = mount( /*#__PURE__*/React.createElement(IconSettings, {
  ...
  describe('App Launcher Icon', function () {
    ...
    it('renders all App Launcher dots', function () {
      expect(handles.appLauncherIcon.find('.slds-icon-waffle').containsAllMatchingElements([/*#__PURE__*/React.createElement("span", {
        className: "slds-r1"
