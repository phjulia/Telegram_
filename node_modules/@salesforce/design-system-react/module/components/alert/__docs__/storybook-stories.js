...
storiesOf(ALERT, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(Offline, null);
}).add('Dismissable', function () {
  return /*#__PURE__*/React.createElement(Dismissable, null);
}).add('Close alert', function () {
  return /*#__PURE__*/React.createElement(CloseAlert, null);
}).add('Custom Class Names', function () {
  return /*#__PURE__*/React.createElement(CustomClassNames, null);
}).add('Custom Styles', function () {
  return /*#__PURE__*/React.createElement(CustomStyles, null);
});
