...
var DemoComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DemoComponent, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement(Dropdown, _extends({}, defaultProps, this.props), this.props.children));
    }
  }]);
...
describe('SLDSMenuDropdown', function () {
  ...
  describe('multiple selection', function () {
    ...
    it('selects multiple items and renders checkmarks', function () {
      ...
      var secondNode = openNodes.menu.find('.slds-dropdown__item a').at(2);
      secondNode.simulate('click');
      var thirdNode = openNodes.menu.find('.slds-dropdown__item a').at(3);
      openNodes = getNodes({
        wrapper: this.wrapper
  ...
  describe('Hoverable', function () {
    ...
    var createDropdown = function createDropdown(props) {
      return /*#__PURE__*/React.createElement(Dropdown, assign({}, defaultProps, props));
    };
    ...
    beforeEach(function () {
      ...
      var _cmp$getElementsByCla = cmp.getElementsByClassName('slds-dropdown-trigger');
  ...
  describe('Hybrid-able', function () {
    ...
    beforeEach(function () {
      ...
      var _cmp$getElementsByCla3 = cmp.getElementsByClassName('slds-dropdown-trigger');
  ...
  describe('Tooltips function as expected', function () {
    beforeEach(mountComponent( /*#__PURE__*/React.createElement(DemoComponent, {
      ...
      tooltipMenuItem: /*#__PURE__*/React.createElement(Tooltip, null)
    })));
    afterEach(unmountComponent);
