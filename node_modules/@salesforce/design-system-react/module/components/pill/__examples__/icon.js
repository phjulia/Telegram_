...
var Example = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(IconSettings, {
      ...
      }, this.state.pill1 ? /*#__PURE__*/React.createElement(Pill, {
        labels: {
          label: 'Pill Label',
        ...
        className: "slds-p-horizontal_medium"
      }, this.state.pill2 ? /*#__PURE__*/React.createElement(Pill, {
        labels: {
          label: 'Pill Label',
          title: 'Full pill label verbiage mirrored here',
          removeTitle: 'Remove'
        ...
        className: "slds-p-horizontal_medium"
      }, this.state.pill3 ? /*#__PURE__*/React.createElement(Pill, {
        labels: {
          label: 'Pill Label',
          title: 'Full pill label verbiage mirrored here',
          removeTitle: 'Remove'
