...
describe('SLDSModal: ', function () {
  ...
  var renderModal = function renderModal(modalInstance) {
    ...
    var opener = /*#__PURE__*/React.createElement("button", {
      type: "button"
  ...
  var createModal = function createModal(props) {
    return /*#__PURE__*/React.createElement(SLDSModal, assign({}, defaultProps, props));
  };
  ...
  var getModalContainerNode = function getModalContainerNode(dom) {
    return dom.querySelector('[role="dialog"]') || dom.querySelector('[role="alertdialog"]');
  };
  ...
  describe('Proper HTML markup', function () {
    it('dismissible modal has role=dialog', function () {
      ...
      var modal = getModalContainerNode(document.body);
  ...
  describe('Open with Prompt and Footer', function () {
    var modal;
    beforeEach(function () {
      var feet = /*#__PURE__*/React.createElement("div", {
        className: "toes"
      }, "Toes");
      getModal({
        isOpen: true,
    ...
    it('adds the default h1 heading element', function () {
      var header = modal.querySelector('section .slds-modal__header h1');
  ...
  describe('Open Directional', function () {
    ...
    beforeEach(function () {
      var feet = [/*#__PURE__*/React.createElement("div", {
        key: "test-content1",
        className: "toes"
      }, "Toe 1"), /*#__PURE__*/React.createElement("div", {
        key: "test-content2",
        className: "toes"
      }, "Toe 2")];
      getModal({
  ...
  describe('Keyboard behavior', function () {
    var modal;
    beforeEach(function () {
      var feet = [/*#__PURE__*/React.createElement("button", {
        type: "button",
        key: "test-content1",
        className: "cancel"
