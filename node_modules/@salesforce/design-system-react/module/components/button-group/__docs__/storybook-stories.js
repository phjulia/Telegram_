...
storiesOf(BUTTON_GROUP, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(MoreIcon, null);
}).add('Icon Group', function () {
  return /*#__PURE__*/React.createElement(IconGroup, null);
}).add('Checkbox', function () {
  return /*#__PURE__*/React.createElement(Checkbox, null);
}).add('Checkbox Error', function () {
  return /*#__PURE__*/React.createElement(CheckboxError, null);
}).add('List Variant', function () {
  return /*#__PURE__*/React.createElement(ListVariant, null);
});
