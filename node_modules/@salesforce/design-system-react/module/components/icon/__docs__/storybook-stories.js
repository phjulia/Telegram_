...
storiesOf(ICON, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(Standard, null);
}).add('Category: Standard - Right to Left (RTL)', function () {
  return makeRtl( /*#__PURE__*/React.createElement(Standard, null));
}).add('Category: Utility', function () {
  return /*#__PURE__*/React.createElement(Utility, null);
}).add('Category: Action', function () {
  return /*#__PURE__*/React.createElement(Action, null);
}).add('Category: Doctype', function () {
  return /*#__PURE__*/React.createElement(Doctype, null);
}).add('Category: Custom', function () {
  return /*#__PURE__*/React.createElement(Custom, null);
}).add('Category: External Path', function () {
  return /*#__PURE__*/React.createElement(ExternalPath, null);
}).add('Size: X-Small', function () {
  return /*#__PURE__*/React.createElement(SizesExtraSmall, null);
}).add('Size: Small', function () {
  return /*#__PURE__*/React.createElement(SizesSmall, null);
}).add('Size: Medium (default)', function () {
  return /*#__PURE__*/React.createElement(SizesMedium, null);
}).add('Size: Large', function () {
  return /*#__PURE__*/React.createElement(SizesLarge, null);
  ...
  }, /*#__PURE__*/React.createElement(ColorBase, null));
}).add('Color: Default', function () {
  return /*#__PURE__*/React.createElement(ColorDefault, null);
}).add('Color: Success', function () {
  return /*#__PURE__*/React.createElement(ColorSuccess, null);
}).add('Color: Error', function () {
  return /*#__PURE__*/React.createElement(ColorError, null);
}).add('Color: Warning', function () {
  return /*#__PURE__*/React.createElement(ColorWarning, null);
}).add('Color: Light', function () {
  return /*#__PURE__*/React.createElement(ColorLight, null);
  ...
  return /*#__PURE__*/React.createElement(ProductThemes, null);
}).add('Docs site Categories', function () {
  return /*#__PURE__*/React.createElement(Categories, null);
