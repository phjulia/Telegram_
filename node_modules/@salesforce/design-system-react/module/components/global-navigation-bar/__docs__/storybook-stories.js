...
var getGlobalNavigationBar = function getGlobalNavigationBar(props, primaryRegionProps) {
  return /*#__PURE__*/React.createElement(GlobalNavigationBar, props, /*#__PURE__*/React.createElement(GlobalNavigationBarRegion, _extends({
    region: "primary"
  }, primaryRegionProps), /*#__PURE__*/React.createElement(AppLauncher, {
    ...
    title: "All Items"
  }, /*#__PURE__*/React.createElement(AppLauncherTile, {
    title: "Marketing Cloud",
    iconText: "MC",
    description: "Send emails, track emails, read emails! Emails!",
    onClick: action('Tile clicked!')
  })))), /*#__PURE__*/React.createElement(GlobalNavigationBarRegion, {
    region: "secondary",
    navigation: true
  }, /*#__PURE__*/React.createElement(GlobalNavigationBarLink, {
  ...
  }), /*#__PURE__*/React.createElement(GlobalNavigationBarDropdown, {
    assistiveText: {
  ...
  }), /*#__PURE__*/React.createElement(GlobalNavigationBarLink // will actually go to website
  , {
    active: true,
    href: "https://www.lightningdesignsystem.com/",
    label: "Menu Item"
...
var getGlobalNavigationBarCustomCloud = function getGlobalNavigationBarCustomCloud(props, primaryRegionProps) {
  return /*#__PURE__*/React.createElement(GlobalNavigationBar, props, /*#__PURE__*/React.createElement(GlobalNavigationBarRegion, _extends({
    region: "primary"
  }, primaryRegionProps), /*#__PURE__*/React.createElement(AppLauncher, _extends({
    onSearch: searchClicked('App Launcher searched')
  }, primaryRegionProps.appLauncher), /*#__PURE__*/React.createElement(AppLauncherExpandableSection, {
    title: "All Items"
  }, /*#__PURE__*/React.createElement(AppLauncherTile, {
    title: "Marketing Cloud",
    iconText: "MC",
    ...
    region: "tertiary"
  }, /*#__PURE__*/React.createElement(GlobalNavigationBarButton, {
    label: "Button",
    onClick: buttonClicked('Button clicked')
  }), /*#__PURE__*/React.createElement(GlobalNavigationBarLink, {
    label: "Actions",
    onClick: linkClicked('Link clicked')
  }), /*#__PURE__*/React.createElement(GlobalNavigationBarLabel, {
...
var getGlobalNavigationBarCustomCloudOverviewActive = function getGlobalNavigationBarCustomCloudOverviewActive(props, primaryRegionProps) {
  return /*#__PURE__*/React.createElement(GlobalNavigationBar, props, /*#__PURE__*/React.createElement(GlobalNavigationBarRegion, {
    region: "primary"
  }, /*#__PURE__*/React.createElement(AppLauncher, _extends({
    onSearch: searchClicked('App Launcher searched')
  }, primaryRegionProps.appLauncher), /*#__PURE__*/React.createElement(AppLauncherExpandableSection, {
    title: "All Items"
  }, /*#__PURE__*/React.createElement(AppLauncherTile, {
