...
storiesOf(SETUP_ASSISTANT, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(StepProgress, {
    action: action
  });
}).add('Hub with Expandable Steps', function () {
  return /*#__PURE__*/React.createElement(HubWithExpandableSteps, {
    action: action
  });
  ...
  return /*#__PURE__*/React.createElement(WithIcons, {
    action: action
  });
});
