...
storiesOf(DYNAMIC_ICON, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(Ellie, null);
}).add('Eq', function () {
  return /*#__PURE__*/React.createElement(Eq, null);
}).add('Score', function () {
  return /*#__PURE__*/React.createElement(Score, null);
}).add('Strength', function () {
  return /*#__PURE__*/React.createElement(Strength, null);
}).add('Trend', function () {
  return /*#__PURE__*/React.createElement(Trend, null);
}).add('Typing', function () {
  return /*#__PURE__*/React.createElement(Typing, null);
}).add('Waffle', function () {
  return /*#__PURE__*/React.createElement(Waffle, null);
});
