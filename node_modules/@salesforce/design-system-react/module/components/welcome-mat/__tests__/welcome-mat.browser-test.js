...
describe('SLDSWelcomeMat: ', function () {
  ...
  var renderWelcomeMat = function renderWelcomeMat(welcomeMatInstance) {
    ...
    var opener = /*#__PURE__*/React.createElement(IconSettings, {
      iconPath: "/assets/icons"
    }, welcomeMatInstance);
    document.body.appendChild(container); // eslint-disable-next-line react/no-render-return-value
  ...
  var createWelcomeMat = function createWelcomeMat(props) {
    return /*#__PURE__*/React.createElement(SLDSWelcomeMat, assign({}, defaultProps, props));
  };
  ...
  var tiles = [/*#__PURE__*/React.createElement(SLDSWelcomeMatTile, {
    title: "Welcome to Salesforce!",
    description: "Lorem ipsum dolor sit amet, lorem ipsum dolor sit amet.",
    icon: "animal_and_nature",
    href: "https://example.com",
    isComplete: true
  }), /*#__PURE__*/React.createElement(SLDSWelcomeMatTile, {
  ...
  describe('Info-Only Variant', function () {
    beforeEach(function () {
      getWelcomeMat({
        ...
        id: 'welcome-mat-test',
        children: tiles,
        doNotShowAgainCheckbox: /*#__PURE__*/React.createElement(SLDSCheckbox, {
          assistiveText: {
        ...
        onRenderInfoActions: function onRenderInfoActions() {
          return /*#__PURE__*/React.createElement(SLDSButton, {
            type: "button",
            variant: "brand",
            title: "Learn More",
            label: "Learn More"
  ...
  describe('Trailhead Variant', function () {
    beforeEach(function () {
      getWelcomeMat({
        ...
        labels: labels,
        children: tiles,
        infoBadge: /*#__PURE__*/React.createElement(WelcomeMatInfoBadge, {
          image: "/assets/images/welcome-mat/trailhead_badge@2x.png",
          onCompleteRenderActions: function onCompleteRenderActions() {
            return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "Cha-ching! You earned the badge."), /*#__PURE__*/React.createElement(SLDSButton, {
        ...
        }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Lightning Explorer"))),
        id: 'welcome-mat-test'
      });
    });
    it('renders welcome mat', function () {
