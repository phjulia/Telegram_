...
storiesOf(WELCOME_MAT, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(StepsComplete, {
    isOpen: true
  });
}).add('Info Only', function () {
  return /*#__PURE__*/React.createElement(InfoOnly, {
    isOpen: true
  });
}).add('Splash', function () {
  ...
  return /*#__PURE__*/React.createElement(TrailHead, {
    isOpen: true
  });
}).add('Trailhead Complete', function () {
  return /*#__PURE__*/React.createElement(TrailHeadComplete, {
    isOpen: true
  });
});
