...
var TabsDemoComponent = /*#__PURE__*/function (_React$Component) {
  _inherits(TabsDemoComponent, _React$Component);

  var _super = _createSuper(TabsDemoComponent);
  ...
  _createClass(TabsDemoComponent, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        id: id
      }, attributes), /*#__PURE__*/React.createElement(Panel, {
        label: "Tab A"
      }, /*#__PURE__*/React.createElement("p", null, "This is tab A")), /*#__PURE__*/React.createElement(Panel, {
        label: "Tab B",
        disabled: true
      }, /*#__PURE__*/React.createElement("p", null, "This is tab B."), /*#__PURE__*/React.createElement("p", null, "It is disabled.")), /*#__PURE__*/React.createElement(Panel, {
        label: "Tab C",
        hasError: true
      }, /*#__PURE__*/React.createElement("p", null, "This is tab C"), /*#__PURE__*/React.createElement("p", null, "It has an error icon next to the tab label.")), /*#__PURE__*/React.createElement(Panel, {
        label: "Always No"
      }, /*#__PURE__*/React.createElement("p", null, "This one can not be selected from the tabs list because this example provides a custom ", /*#__PURE__*/React.createElement("code", null, "onSelct"), " function that retuns false when it is run, preventing the component\u2019s built-in handler from running, and thus the tab is never selected."), /*#__PURE__*/React.createElement("p", null, "Note that you ", /*#__PURE__*/React.createElement("em", null, "can"), " still see the panel if you hide the other tabs, because the tab/panel are not ", /*#__PURE__*/React.createElement("em", null, "disabled"), "."), /*#__PURE__*/React.createElement("p", null, "In other words, this should not be taken as an example of how to be sneaky about disabling tab selection, but rather that you can", ' ', /*#__PURE__*/React.createElement("strong", null, "do stuff"), " when a tab is selected by sending it a custom ", /*#__PURE__*/React.createElement("code", null, "onSelect"), " function."))));
    }
  }]);
...
describe('Tabs', function () {
  ...
  describe('Default structure and CSS', function () {
    ...
    before(mountComponent( /*#__PURE__*/React.createElement(TabsDemoComponent, {
  ...
  describe('Assistive technology', function () {
    ...
    it('Has a tabindex of -1 on the second tab.', function () {
      var myTabsListItem = this.wrapper.find(".".concat(COMPONENT_CSS_CLASSES.item, ".slds-disabled a"));
