...
describe('Card: ', function () {
  ...
  var renderCard = function renderCard(instance) {
    return function renderCardFunction() {
      ...
      this.component = ReactDOM.render( /*#__PURE__*/React.createElement(IconSettings, {
  ...
  describe('Default Structure', function () {
    beforeEach(renderCard( /*#__PURE__*/React.createElement(Card, requiredProps)));
  ...
  var renderFooterContents = /*#__PURE__*/React.createElement('span', {
    id: 'sampleFooter'
  });
  var renderHeaderActions = /*#__PURE__*/React.createElement('span', {
    id: 'sampleHeaderActions'
  });
  var renderFilter = /*#__PURE__*/React.createElement(CardFilter);
  var renderIcon = /*#__PURE__*/React.createElement(Icon, {
    category: 'standard',
    name: 'default',
    size: 'small'
  });
  ...
  var optionalProps = assign(requiredProps, (_assign = {
  ...
  }, _defineProperty(_assign, ariaLabel, ariaLabel), _defineProperty(_assign, dataLabel, dataLabel), _assign));
  describe('Optional Structure', function () {
    beforeEach(renderCard( /*#__PURE__*/React.createElement(Card, optionalProps)));
    afterEach(removeCard);
    it('has a header', function () {
      var header = getHeader(this.dom);
      header.should.not.be.undefined;
  ...
  describe('Accepts a custom node as heading', function () {
    ...
    beforeEach(renderCard( /*#__PURE__*/React.createElement(Card, props)));
    afterEach(removeCard);
