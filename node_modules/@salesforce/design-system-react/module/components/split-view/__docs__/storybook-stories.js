...
storiesOf(SPLIT_VIEW, module).addDecorator(function (getStory) {
  ...
  return /*#__PURE__*/React.createElement(BaseMultiple, null);
}).add('External State', function () {
  return /*#__PURE__*/React.createElement(ExternalState, null);
}).add('Custom List', function () {
  return /*#__PURE__*/React.createElement(CustomItemList, null);
});
